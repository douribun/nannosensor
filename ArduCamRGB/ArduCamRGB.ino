...
//************************ set the envorinmental data of Network ********************************
static const int wifiType = 1; // 0:Station  1:AP
//AP mode configuration
const char *AP_ssid = "microscope_IEUM";
//Default is no password.If you want to set password,put your password here
const char *AP_password = "";
//Station mode you should put your ssid and password
const char *ssid = "IEUM"; //"kims"; //
const char *password = "IEUM4728"; //"47285840"; //
static IPAddress ip(192, 168, 0, 200); // static IP used for browser access: http://IPaddress
